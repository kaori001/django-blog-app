...
from blog.views import PostListView, PostDetailView, CategoryPostListView, TagPostListView, SearchPostListView, CommentCreateView, CommentDeleteView, ReplyCreateView, ReplyDeleteView
